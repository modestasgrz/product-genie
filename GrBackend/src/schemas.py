...
ASSETS_MAP = {
    "Movement": {
        ...
        "Camera dutch-angle-zoom in on the product, product static": "CAMERA_DUTCH_ZOOM_IN",
...
class ShotCompositionParams(BaseModel):
    ...
    def preprocess_fields(cls, values: object) -> object:
        ...
        values["movement"] = ASSETS_MAP.get("Movement").get(movement)
        ...
        values["vfx_shot"] = ASSETS_MAP.get("VFX").get(vfx_shot, "None")
